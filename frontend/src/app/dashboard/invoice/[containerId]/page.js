...
import { 
  ...
  Eye, Package, DollarSign, History, Building2, Landmark, Users, Upload
} from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto">
            ...
            <div>
              <div className="flex items-center gap-3">
                ...
                <span className={`px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider border transition-colors ${
                  invoice ? 'bg-green-100 text-green-800 border-green-200' : 'bg-amber-100 text-amber-800 border-amber-200'
                }`}>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden mb-8">
           ...
           <div className={`px-6 py-3 flex justify-between items-center border-b ${
             invoice ? 'bg-green-50 text-green-800 border-green-100' : 'bg-slate-50 text-slate-600 border-slate-100'
           }`}>
                         ...
                         {formData.stampImage ? (
                           <>
                             <div className="w-full h-24 relative mb-2">
                               <img 
                                 src={process.env.NEXT_PUBLIC_SERVER_URL + formData.stampImage} 
                                 alt="Stamp" 
                      ...
                      <div className="flex gap-2">
                        {['BOTTOM_LEFT', 'BOTTOM_CENTER', 'BOTTOM_RIGHT'].map((pos) => (
                          <button
                            ...
                            className={`flex-1 py-3 type="button" rounded-xl text-[10px] font-bold transition-all border ${
                              formData.stampPosition === pos 
                  ...
                  <tr key={item.id} className="border-b border-slate-100 hover:bg-slate-50">
                    ...
                    <td className="px-4 py-3">
                      <button
                        ...
                        className="w-16 h-16 border-2 border-dashed border-slate-300 rounded hover:border-blue-500 flex items-center justify-center"
                      >
                        {item.photo ? (
                          <img src={item.photo} alt="" className="w-full h-full object-cover rounded" />
                        ) : (
