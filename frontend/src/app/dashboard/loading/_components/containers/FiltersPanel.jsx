...
function FilterInput({ label, type, value, onChange, placeholder, icon: Icon }) {
  return (
    <div>
      <label className="text-sm font-medium text-gray-700 mb-1.5 block">
        {label}
      ...
      <div className="relative">
        ...
        <input
          ...
          className={`${Icon ? 'pl-10' : 'pl-3'} pr-4 py-2.5 border border-gray-300 rounded-lg w-full focus:ring-2 focus:ring-blue-500 focus:border-blue-500`}
        />
      </div>
    </div>
  );
